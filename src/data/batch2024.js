const Batch2024 = [
   {
      name: "Sagar",
      post: "Junior member",
      img: require("../media/batch2023/Arka.jpg"),
   ...
   },
   {
      name: "Arka",
      post: "Junior member",
      img: require("../media/batch2023/Sagar.jpg"),
   ...
   },
   {
      name: "Sayan",
      post: "Junior member",
      img: require("../media/batch2023/Sayan.jpg"),
   ...
   },
   {
      name: "Aditi",
      post: "Junior member",
      img: require("../media/batch2023/Aditi.jpg"),
   ...
   },
   {
      name: "Vaishali",
      post: "Junior member",
      img: require("../media/batch2023/Vaishali.jpg"),
